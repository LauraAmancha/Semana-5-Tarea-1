...
namespace GestionEscuelaTarea.Controllers
{
    ...
    public class AulasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Ubicacion,Capacidad,TieneProyector")] Aula aula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Ubicacion,Capacidad,TieneProyector")] Aula aula)
        {
            if (id != aula.Id)
            {
                return NotFound();
