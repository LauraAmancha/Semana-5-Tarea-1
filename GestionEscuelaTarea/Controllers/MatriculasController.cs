...
namespace GestionEscuelaTarea.Controllers
{
    ...
    public class MatriculasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Fecha,Periodo,NotaFinal,EstaPagado")] Matricula matricula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fecha,Periodo,NotaFinal,EstaPagado")] Matricula matricula)
        {
            if (id != matricula.Id)
            {
                return NotFound();
